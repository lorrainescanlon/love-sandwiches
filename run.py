...
def validate_data(values):
    ...
    Raises ValieError if strings cannot be converted to int,
...
def update_worksheet(data, worksheet):
    """
    Recived a list of integers to be inserted into a worksheet
    Update the relevant worksheet withe the data provided
    """
